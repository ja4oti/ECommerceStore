...
public class contactUSpage {
	...
	public void ContactUS() {
		...
		Select select2 = new Select(driver.findElement(By.xpath(
				"/html/body/div[1]/div[2]/div/div[3]/div/form/fieldset/div[1]/div[1]/div[2]/div/select")));
		select2.selectByIndex(1);
		
		Select select3 = new Select(driver.findElement(By.xpath("//*[@id=\"30974_order_products\"]")));
		select3.selectByIndex(1);
		
		driver.findElement(By.id("message")).sendKeys("Please add more items on the site, I cannot find alot of things that i need");
